...
import type { WeightFader } from './WeightFader';
...
export class PromptController extends LitElement {
  ...
  @query('weight-fader') private weightInput!: WeightFader;
  ...
  override render() {
    ...
    return html`<div class=${classes}>
      <weight-fader
        ...
        @input=${this.updateWeight}></weight-fader>
      <span
        id="text"
        spellcheck="false"
        @focus=${this.onFocus}
